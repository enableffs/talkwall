...
export class UtilityService implements IUtilityService {
    ...
    getMessageFromQuestionById (id: string, question: models.Question) : models.Message {
        let message: models.Message = null;
    ...
    static getQuestionIndexFromWallById(id: string, wall: models.Wall): number {
        for (let i = 0; i < wall.questions.length; i++) {
    ...
    getPossibleTags(content: string): Array<string> {
        let tags: string[] = null, filteredTags: string[] = [];
