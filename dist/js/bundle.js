...
},{"./app.config":3,"./app.constants":4,"./app.run":5,"./components/archive/archive":7,"./components/close/close":8,"./components/editMessagePanel/editMessagePanel":9,"./components/export/export":10,"./components/feedMessage/feedMessage":11,"./components/join/join":12,"./components/landing/landing":13,"./components/login/login":14,"./components/logs/logs":15,"./components/nvivologs/nvivologs":16,"./components/organiser/organiser":17,"./components/organiserItem/organiserItem":18,"./components/sessioninfo/sessioninfo":19,"./components/taskQuestion/taskQuestion":20,"./components/wall/wall":21,"./directives/autoresize":22,"./directives/twMaxlength":23,"./directives/watchboardsize":24,"./services/authenticationservice":26,"./services/dataservice":27,"./services/tokenservice":28,"./services/urlservice":29,"./services/utilityservice":30}],7:[function(require,module,exports){
/*
 Copyright 2016, 2017 Richard Nesnass and Jeremy Toussaint
...
},{"../../models/models":25}],12:[function(require,module,exports){
/*
 Copyright 2016, 2017 Richard Nesnass and Jeremy Toussaint
...
var JoinController = (function () {
    ...
    JoinController.prototype.filterNickname = function () {
        this.joinModel.nickname = this.joinModel.nickname.replace(/([#0-9]\u20E3)|[\xA9\xAE\u203C\u2047-\u2049\u2122\u2139\u3030\u303D\u3297\u3299][\uFE00-\uFEFF]?|[\u2190-\u21FF][\uFE00-\uFEFF]?|[\u2300-\u23FF][\uFE00-\uFEFF]?|[\u2460-\u24FF][\uFE00-\uFEFF]?|[\u25A0-\u25FF][\uFE00-\uFEFF]?|[\u2600-\u27BF][\uFE00-\uFEFF]?|[\u2900-\u297F][\uFE00-\uFEFF]?|[\u2B00-\u2BF0][\uFE00-\uFEFF]?|(?:\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDEFF])[\uFE00-\uFEFF]?/g, '');
    };
    /**
     * hide this dialog (see angular.material.IDialogService)
     * @aparam response a possible reponse
...
},{"../../services/utilityservice":30}],19:[function(require,module,exports){
/*
 Copyright 2016, 2017 Richard Nesnass and Jeremy Toussaint
