...
(function (TalkwallApp) {
    ...
    var LogType;
    (function (LogType) {
        LogType[LogType["EditMessage"] = 0] = "EditMessage";
        LogType[LogType["MarkMessage"] = 1] = "MarkMessage";
        LogType[LogType["EditTask"] = 2] = "EditTask";
        LogType[LogType["AddTask"] = 3] = "AddTask";
        LogType[LogType["PromoteMessage"] = 4] = "PromoteMessage";
        LogType[LogType["MoveMessage"] = 5] = "MoveMessage";
    })(LogType || (LogType = {}));
    var User = (function () {
        function User() {
        }
    ...
    var LogEntry = (function () {
        function LogEntry(type, id, nickname, diff) {
            this.type = type;
            this.id = id;
...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        ...
        DataService.prototype.logAnEvent = function (type, id, diff) {
            this.data.log.push(new TalkwallApp.LogEntry(type, id, this.data.status.nickname, diff));
        };
