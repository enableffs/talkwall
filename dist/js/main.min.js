...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        function DataService($http, $window, $routeParams, $location, utilityService, urlService, $mdMedia) {
            this.$http = $http;
            this.$window = $window;
        ...
        */
        ...
        DataService.$inject = ['$http', '$window', '$routeParams', '$location', 'UtilityService', 'URLService', '$mdMedia'];
        return DataService;
    }());
