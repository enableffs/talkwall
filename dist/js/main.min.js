...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        function DataService($http, $window, $routeParams, $location, utilityService) {
            this.$http = $http;
            this.$window = $window;
        ...
        DataService.prototype.checkAuthenticated = function (successCallbackFn) {
            var handle = this;
            var tKey = 'authenticationToken';
            ...
            if (tokenParam !== '') {
                ...
                this.getUser(function (user) {
                    ...
                    handle.getLastWall(handle.user.lastOpenedWall, function (wall) {
                        handle.wall = wall;
                        successCallbackFn();
                    }, function (error) {
        ...
        DataService.prototype.getUser = function (successCallbackFn, errorCallbackFn) {
        ...
        DataService.prototype.getLastWall = function (wallId, successCallbackFn, errorCallbackFn) {
        ...
        DataService.prototype.addQuestion = function (label, successCallbackFn, errorCallbackFn) {
            ...
            var question = new TalkwallApp.Question();
        ...
        DataService.$inject = ['$http', '$window', '$routeParams', '$location', 'UtilityService'];
        return DataService;
    }());
...
(function (TalkwallApp) {
    ...
    var LandingController = (function () {
        function LandingController(urlService, $translate, $mdMedia, $mdDialog, $window) {
        ...
        LandingController.$inject = ['URLService', '$translate', '$mdMedia', '$mdDialog', '$window'];
...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        ...
        WallController.prototype.refreshQuestion = function () {
            var handle = this;
            this.dataService.setQuestion(this.currentQuestionIndex, function () {
                //question updated
            }, function (error) {
        ...
        WallController.prototype.postNewQuestion = function () {
            var handle = this;
            this.dataService.addQuestion(this.newQuestionLabel, function () {
                //success
        ...
        WallController.prototype.getLocationPosition = function (e, p) {
            var xposKey = 'xpos';
            var yposKey = 'ypos';
            var leftKey = 'left';
            var topKey = 'top';
            var calcTopPos = p[yposKey] * this.viewHeight;
            var calcLeftPos = p[xposKey] * this.viewWidth;
            var pos = {
