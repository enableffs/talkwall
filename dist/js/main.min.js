    ...
    var DataService = (function () {
        ...
        DataService.prototype.startPolling = function (previous_question_id, control) {
            ...
            this.requestPoll(previous_question_id, control, function (success) {
                ...
                handle.timerHandle = handle.$interval(function () {
...
(function (TalkwallApp) {
    ...
    var FeedMessageController = (function () {
        function FeedMessageController(isolatedScope, dataService, $document, utilityService) {
            this.isolatedScope = isolatedScope;
            this.dataService = dataService;
            this.$document = $document;
            this.utilityService = utilityService;
            this.showControls = false;
            this.originReversed = new Array();
        ...
        FeedMessageController.$inject = ['$scope', 'DataService', '$document', 'UtilityService'];
