...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        ...
        WallController.prototype.setQuestion = function (questionIndex) {
            ...
            this.dataService.setQuestion(this.currentQuestionIndex, function (newQuestion) {
                //success
                _this.currentQuestion = newQuestion;
            }, function () {
                //error
            });
        };
