...
(function (TalkwallApp) {
    ...
    var Question = (function () {
        ...
        // Return the Question for the given question ID
        Question.prototype.getMessageById = function (id) {
...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        function DataService($http, $window, $routeParams, $location, $interval, utilityService, urlService, $mdMedia) {
            this.$http = $http;
            this.$window = $window;
        ...
        */
        ...
        DataService.$inject = ['$http', '$window', '$routeParams', '$location', '$interval', 'UtilityService', 'URLService', '$mdMedia'];
        return DataService;
    }());
