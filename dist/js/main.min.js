...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        ...
        DataService.prototype.checkAuthenticated = function () {
            ...
            if (tokenParam !== '') {
                ...
                this.getUser(function (user) {
                    ...
                    handle.getWall(handle.user.lastOpenedWall, function (wall) {
                        handle.wall = wall;
                        return true;
                    }, function (error) {
        ...
        DataService.prototype.getWall = function (wallId, successCallbackFn, errorCallbackFn) {
