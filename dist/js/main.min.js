...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        ...
        DataService.prototype.getQuestion = function (questionId, successCallbackFn, errorCallbackFn) {
        ...
        DataService.prototype.postMessage = function (questionId, text, successCallbackFn, errorCallbackFn) {
...
(function (TalkwallApp) {
    ...
    var FeedMessageController = (function () {
        function FeedMessageController(isolatedScope) {
        ...
        FeedMessageController.$inject = ['$scope'];
...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        ...
        WallController.prototype.refreshQuestion = function () {
            var handle = this;
            var idKey = '_id';
            this.dataService.getQuestion(this.dataService.getWall().questions[this.currentQuestionIndex][idKey], function (success) {
                handle.question = success;
            }, function (error) {
                //TODO: handle question retrieval error
            });
        };
        WallController.prototype.showMessageEditor = function () {
            var handle = this;
            ...
            this.$mdBottomSheet.show({
                ...
                handle.dataService.postMessage(handle.question._id, answer, function (message) {
        ...
        WallController.prototype.postNewQuestion = function () {
            var handle = this;
            this.dataService.addQuestion(this.newQuestion, function () {
                //success
                handle.newQuestion = '';
