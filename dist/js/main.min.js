    ...
    var WallController = (function () {
        ...
        WallController.prototype.activate = function () {
            if (this.dataService.getWall() === null) {
                ...
                var handle = this;
                this.messageFilterByContributor = function (message) {
                    if (!message.deleted &&
