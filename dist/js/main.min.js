        ...
        FeedMessageController.prototype.toggleHighlightMessage = function (event) {
            ...
            if (this.dataService.data.status.selectedParticipant === this.dataService.data.status.nickname) {
                this.message.board[this.dataService.data.status.nickname].highlighted
                    = !this.message.board[this.dataService.data.status.nickname].highlighted;
                var highlightLogText = this.message.board[this.dataService.data.status.nickname].highlighted
                    ? TalkwallApp.LogType.HighlightMessage : TalkwallApp.LogType.UnHighlightMessage;
