...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        function DataService($http, $window, $routeParams, $location, $interval, $mdDialog, utilityService, urlService, $mdMedia) {
            this.$http = $http;
            this.$window = $window;
        ...
        DataService.prototype.deleteQuestion = function (question, successCallbackFn, errorCallbackFn) {
            ...
            this.$http.get(this.urlService.getHost() + '/messages/' + question._id)
                ...
                if (data[resultKey].length === 0) {
                    for (var i = 0; i < _this.wall.questions.length; i++) {
                        if (_this.wall.questions[i]._id === question._id) {
                            _this.wall.questions.splice(i, 1);
                        }
                    }
...
(function (TalkwallApp) {
    ...
    var FeedMessageController = (function () {
        function FeedMessageController(isolatedScope, dataService, $document, utilityService, $timeout, $window) {
        ...
        FeedMessageController.$inject = ['$scope', 'DataService', '$document', 'UtilityService', '$timeout', '$window'];
...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        function WallController(dataService, $mdSidenav, $mdBottomSheet, urlService, $window, constants) {
            var _this = this;
            this.dataService = dataService;
        ...
        WallController.prototype.setQuestion = function (index) {
            ...
            this.dataService.setQuestion(index, function () {
                var bgColourKey = 'BACKGROUND_COLOURS', cpColourKey = 'COMPLEMENTARY_COLOURS';
                _this.backgroundColour
                    = _this.constants.constants[bgColourKey][index];
                _this.complementaryColour
                    = _this.constants.constants[cpColourKey][index];
        ...
        WallController.prototype.getGridStyle = function (type) {
        ...
        WallController.$inject = ['DataService', '$mdSidenav', '$mdBottomSheet', 'URLService', '$window', 'TalkwallConstants'];
