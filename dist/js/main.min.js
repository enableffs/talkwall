...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        ...
        DataService.prototype.setQuestion = function (newIndex, successCallbackFn, errorCallbackFn) {
            ...
            if (control !== 'none') {
                ...
                if (this.userAuthorised) {
                    var status = new TalkwallApp.PollUpdate(this.question._id, false);
        ...
        DataService.prototype.closeWallNow = function () {
            var status = new TalkwallApp.PollUpdate('', true);
            this.updateWall(status, null, null);
        };
        ...
        DataService.prototype.updateWall = function (pollupdate, successCallbackFn, errorCallbackFn) {
        ...
        DataService.prototype.processUpdatedMessages = function (pollUpdateObject) {
            ...
            if (!this.userAuthorised) {
                ...
                if (pollUpdateObject.status.commands_to_server.teacher_question_id !== this.mytTeachersQuestionID) {
                    ...
                    this.setQuestion(this.utilityService.getQuestionIndexFromWallById(this.mytTeachersQuestionID, this.wall), null, null);
                }
