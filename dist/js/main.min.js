...
(function (TalkwallApp) {
     ...
     */
    function configApp($translateProvider, $httpProvider, $routeProvider, $mdThemingProvider) {
        // Routes
        $routeProvider.
            when('/export', {
...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        ...
        DataService.prototype.logAnEvent = function (type, id, diff) {
            ...
            this.data.log.push(new TalkwallApp.LogEntry(type, id, this.data.user.nickname, questionId, diff));
        };
        ...
        DataService.prototype.checkAuthentication = function (successCallbackFn, errorCallbackFn) {
            ...
            this.$window.onbeforeunload = function () {
                ...
                _this.$http.get(url + clientType + _this.data.user.nickname + '/' + _this.data.wall._id + '/' + _this.data.question._id)
                    .then(function () {
        ...
        // For authorised users only
        DataService.prototype.requestLogs = function (wall_id, successCallbackFn, errorCallbackFn) {
        ...
        DataService.prototype.getClientWall = function (joinModel, successCallbackFn, errorCallbackFn) {
            ...
            this.$http.get(this.urlService.getHost() + '/clientwall/' + joinModel.nickname + '/' + joinModel.pin)
                ...
                if (success[statusKey] === 204) {
                    ...
                    _this.data.user = new TalkwallApp.User();
        ...
        DataService.prototype.setMessageToEdit = function (message) {
            if (message === null && this.data.status.messageOrigin === null) {
                ...
                this.data.status.messageToEdit = new TalkwallApp.Message().createFromOrigin(this.data.status.messageOrigin, this.data.user.nickname);
        ...
        DataService.prototype.getMessages = function (sFunc, eFunc) {
            var _this = this;
            if (this.data.question !== null) {
        ...
        DataService.prototype.processUpdatedMessages = function (pollUpdateObject) {
            ...
            if (this.data.status.authorised) {
                ...
                if (pollUpdateObject.status.last_update > this.data.status.last_status_update) {
                    ...
                    // Refresh the wall
                    this.getClientWall({ nickname: this.data.user.nickname, pin: this.data.wall.pin }, function () {
...
(function (TalkwallApp) {
    ...
    TalkwallApp.TwMaxlength = TwMaxlength;
})(TalkwallApp || (TalkwallApp = {}));
/// <reference path="../../_references.ts"/>
/// <reference path="../../models/models.ts"/>
/// <reference path="../../services/dataservice.ts"/>
...
(function (TalkwallApp) {
    ...
    var OrganiserItemController = (function () {
        function OrganiserItemController(isolatedScope, dataService, $document, utilityService, $window) {
            var _this = this;
            this.isolatedScope = isolatedScope;
            this.dataService = dataService;
            this.$document = $document;
            ...
            this.timeFromNow = TalkwallApp.UtilityService.getFormattedDateTimeFromNow(this.wall.lastOpenedAt);
        ...
        OrganiserItemController.prototype.editDetails = function () {
        ...
        OrganiserItemController.prototype.submitEditedDetails = function () {
            this.dataService.updateWall(this.wall, null, null);
            this.showEditor = false;
        };
        OrganiserItemController.$inject = ['$scope', 'DataService', '$document', 'UtilityService', '$window'];
    ...
    TalkwallApp.OrganiserItem = OrganiserItem;
})(TalkwallApp || (TalkwallApp = {}));
/// <reference path="../../_references.ts"/>
/// <reference path="../../models/models.ts"/>
/// <reference path="../../services/dataservice.ts"/>
    ...
    var LandingController = (function () {
        ...
        LandingController.prototype.showJoinDialog = function (ev) {
            ...
            this.$mdDialog.show({
                ...
                .then(function (answer) {
                _this.$window.blur();
                handle.dataService.getClientWall(answer, function () {
...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        ...
        WallController.prototype.toggleLock = function () {
            ...
            this.dataService.updateWall(null, function (wall) {
                _this.dataService.data.wall.pin = wall.pin;
            }, function () {
                console.log('error updating wall');
            });
        };
...
(function (TalkwallApp) {
    ...
    var OrganiserController = (function () {
        function OrganiserController(dataService, $mdSidenav, $mdBottomSheet, $translate, $scope, $timeout, urlService, $window, utilityService) {
            var _this = this;
            this.dataService = dataService;
            this.$mdSidenav = $mdSidenav;
            this.$mdBottomSheet = $mdBottomSheet;
        ...
        OrganiserController.prototype.openWall = function (wall) {
            ...
            if (!wall.closed) {
                ...
                this.dataService.requestWall(wall._id, function () {
    ...
    TalkwallApp.OrganiserController = OrganiserController;
})(TalkwallApp || (TalkwallApp = {}));
/// <reference path="../../_references.ts"/>
/// <reference path="../../models/models.ts"/>
/// <reference path="../../services/urlservice.ts"/>
...
(function (TalkwallApp) {
    ...
    TalkwallApp.LogController = LogController;
})(TalkwallApp || (TalkwallApp = {}));
/// <reference path="../../_references.ts"/>
/// <reference path="../../services/urlservice.ts"/>
/// <reference path="../login/login.ts"/>
...
(function (TalkwallApp) {
    ...
    angular.module('TalkwallApp', dependencies)
        ...
        .controller('OrganiserController', TalkwallApp.OrganiserController)
        .controller('LogController', TalkwallApp.LogController)
