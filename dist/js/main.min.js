...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        function WallController(dataService, $mdSidenav, $mdBottomSheet, urlService, $window, utilityService) {
            var _this = this;
            this.dataService = dataService;
        ...
        WallController.$inject = ['DataService', '$mdSidenav', '$mdBottomSheet', 'URLService', '$window', 'UtilityService'];
