...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        ...
        DataService.prototype.restrictRequests = function () {
            ...
            this.timerhandle = this.$timeout(function () {
        ...
        DataService.prototype.startPolling = function (previous_question_id, controlString) {
            var handle = this;
        ...
        DataService.prototype.processUpdatedMessages = function (pollUpdateObject) {
            ...
            function checkAndRemoveDeletedContributor(nickname) {
                ...
                this.data.status.contributors.forEach(function (user, index) {
                    if (user === nickname) {
                        foundIndex = index;
                        counter++;
                    }
                ...
                counter = 0;
                foundIndex = -1;
                this.data.status.unselected_contributors.forEach(function (user, index) {
                    if (user === nickname) {
                        foundIndex = index;
                        counter++;
                    }
            ...
            for (var message_id in pollUpdateObject.updated) {
                var updated_message = pollUpdateObject.updated[message_id];
                var old_message = this.utilityService.getMessageFromQuestionById(message_id, this.data.question);
                if (old_message !== null) {
