...
(function (TalkwallApp) {
    ...
    var DataService = (function () {
        function DataService($http, $window, $routeParams, $location, $interval, $mdDialog, $translate, utilityService, urlService, $mdMedia, constants) {
            var _this = this;
            this.$http = $http;
            this.$window = $window;
        ...
        DataService.prototype.getPhoneMode = function () {
        ...
        DataService.prototype.addMessage = function (successCallbackFn, errorCallbackFn) {
            ...
            this.$http.post(this.urlService.getHost() + '/message', {
                ...
                _this.parseMessageForTags(data[resultKey]);
                _this.messageToEdit = null;
                if (_this.updateOrigin) {
                    //the new cloned message has been posted, remove the nickname from the old one
                    delete _this.messageOrigin.board[_this.getNickname()];
                    //update the orgin message, so it will be removed from the board from the current user
                    _this.$http.put(_this.urlService.getHost() + '/message', {
                        message: _this.messageOrigin,
                        pin: _this.wall.pin,
                        ...
                        _this.updateOrigin = false;
                        if (_this.messageOrigin !== null) {
                            _this.messageOrigin = null;
                        }
        ...
        DataService.prototype.getContributors = function () {
            return this.contributors;
        };
        DataService.prototype.getTags = function () {
            return this.tags;
        };
        DataService.prototype.getTagCounter = function () {
        ...
        DataService.prototype.processUpdatedMessages = function (pollUpdateObject) {
                ...
                if (this.userAuthorised) {
                    ...
                    if (refreshNeeded && this.wall !== null && this.question !== null) {
                        this.$http.get(this.urlService.getHost() + '/wall/' +
                            ...
                            var resultKey = 'result';
                            _this.contributors = data[resultKey];
                        })
                            .catch(function (error) {
            ...
            pollUpdateObject.messages.forEach(function (updated_message) {
                ...
                if (old_message !== null) {
                    ...
                    var idKey = '_id';
                    for (var i = 0; i < _this.question.messages.length; i++) {
                        if (_this.question.messages[i][idKey] === updated_message._id) {
                            _this.question.messages.splice(i, 1);
                            _this.question.messages.splice(i, 0, updated_message);
                            break;
                        }
                    }
                }
                ...
                _this.parseMessageForTags(updated_message);
            });
        };
        ...
        DataService.$inject = ['$http', '$window', '$routeParams', '$location', '$interval', '$mdDialog', '$translate',
...
(function (TalkwallApp) {
    ...
    var FeedMessageController = (function () {
        ...
        ;
        FeedMessageController.prototype.isSelected = function () {
        ...
        FeedMessageController.prototype.getSelectedClass = function () {
...
(function (TalkwallApp) {
    ...
    var WallController = (function () {
        function WallController(dataService, $mdSidenav, $mdBottomSheet, $translate, urlService, $window, utilityService) {
            var _this = this;
            this.dataService = dataService;
        ...
        WallController.$inject = ['DataService', '$mdSidenav', '$mdBottomSheet', '$translate', 'URLService', '$window', 'UtilityService'];
