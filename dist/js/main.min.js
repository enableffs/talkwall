                ...
                this.requestUser(function (user) {
                    if (user.lastOpenedWall === null) {
                        ...
                        _this.$mdDialog.show(confirm).then(function () {
                            ...
                            _this.$http.get(_this.urlService.getHost() + '/close/' + user.lastOpenedWall)
