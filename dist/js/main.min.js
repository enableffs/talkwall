...
(function (TalkwallApp) {
    ...
    var LandingController = (function () {
        function LandingController(urlService, $translate, $mdMedia, $mdDialog, isolatedScope, $window) {
        ...
        LandingController.$inject = ['URLService', '$translate', '$mdMedia', '$mdDialog', '$scope', '$window'];
